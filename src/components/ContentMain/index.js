...
// 博客
const Verse = LoadableComponent(()=>import('../../routes/Blog/Verse/index'));
const Article = LoadableComponent(()=>import('../../routes/Blog/Article/index'));
    ...
    return (
      <div style={{padding: 16, position: 'relative'}}>
        <Switch>
          ...
          <PrivateRoute exact path='/home/blog/verse' component={Verse}/>
          <PrivateRoute exact path='/home/blog/article' component={Article}/>
